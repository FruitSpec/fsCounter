...
def get_intercetion_point(df_res):
    """
...
def filer_df(df_res, apply_filter_by_color=True, apply_filter_by_dist=True, min_samples=3, min_x1=50):
    """
...
def trackers_into_values(df_res, df_tree=None, df_border=None, apply_filter_by_color=True, apply_filter_by_dist=True,
    ...
    df_res = filer_df(df_res, apply_filter_by_color, apply_filter_by_dist, min_samples, min_x1)
