...
from sensors_alignment import get_coordinates_in_zed, cut_black
...
def manual_calibration(zed_filepath, jai_filepath, output_path, data=None, zed_rotate=2, jai_rotate=1,
                       index=0, draw_start=None, draw_end=None, size=1440):
    """
...
def data_to_coords(zed, jai, data):
    ...
    x1, y1, x2, y2 = get_coordinates_in_zed(zed, jai, tx, ty, sx, sy)
    return x1, y1, x2, y2
...
if __name__ == "__main__":
    jai_im_path = "/media/yotam/easystore/preTiltDown40cm/relevent_movies/frames/channel_FSI_frame_50.jpg"
    zed_im_path = "/media/yotam/easystore/preTiltDown40cm/relevent_movies/frames/frame_50.jpg"
    zed_fp = '/media/yotam/easystore/preTiltDown40cm/relevent_movies/ZED_2_2nd.svo'
    jai_fp = '/media/yotam/easystore/preTiltDown40cm/relevent_movies/Result_FSI_2.mkv'
    output_path = '/media/yotam/easystore/preTiltDown40cm/relevent_movies'
    json_path = "/media/yotam/easystore/preTiltDown40cm/relevent_movies/calibration_data.json"
    json_path_real = "/media/yotam/easystore/preTiltDown40cm/relevent_movies/calibration_data_real.json"
    #
    # with open(json_path) as json_file:
    #     data = json.load(json_file)
    # data = {int(key): value for key, value in data.items()}

    manual_calibration(zed_fp, jai_fp, output_path, zed_rotate=2, jai_rotate=1, index = 50)
    ...
    check_correctness(zed_im_path, jai_im_path, real_data)
