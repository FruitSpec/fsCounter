...
from vision.pipelines.ops.distance_slicer import slice_frames
...
if __name__ == '__main__':
    ...
    #row_path = "/media/matans/My Book/FruitSpec/Customers_data/Fowler/daily/OLIVER12/180723/row_11/1"
    row_path = "/media/matans/My Book/FruitSpec/Customers_data/Fowler/plots/MAZMANI2/170723/row_20/1"
    ANNOTATIONS_FILE_PATH = os.path.join(row_path, "all_slices.csv")
    INPUT_VIDEO_PATH = os.path.join(row_path, "Result_FSI.mkv")
    OUTPUT_FRAMES_PATH = row_path
    COCO_ANNOTATIONS_PATH = ''

    #PATH_GPS = r'/media/matans/My Book/FruitSpec/Customers_data/Fowler/nav/180723.nav'
    PATH_GPS = r'/media/matans/My Book/FruitSpec/Customers_data/Fowler/nav/170723.nav'
    ...
    updated_df = slice_inside_frames(path_slices_csv=path_slices_file, path_translations_csv=PATH_TRANSLATIONS,
                                     frame_width=1535,
