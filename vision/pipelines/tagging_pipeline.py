    ...
    while (cap.isOpened()):
        ...
        if ret == True and (f_id in track_frames or f_id in annotate_frames):
            ...
            if args.debug.is_debug and f_id in annotate_frames:
                ...
                results_collector_annotate.debug(f_id, args, trk_outputs, det_outputs, frame, trk_windows=trk_windows)
            ...
            if args.debug.is_debug and f_id in track_frames:
                ...
                results_collector_track.debug(f_id, args, trk_outputs, det_outputs, frame, trk_windows=trk_windows)
