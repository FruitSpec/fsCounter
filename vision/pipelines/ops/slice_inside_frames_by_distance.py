...
def slice_inside_frames(path_slices_csv, path_translations_csv, frame_width, output_path=None):
    ...
    # def process_end_pixels(slices_df):
    #     for frame_id in slices_df["frame_id"]:
    #         indx = slices_df[slices_df["frame_id"] == frame_id].index
    #         if len(indx) == 1:
    #             continue
    #         if slices_df.loc[indx[0], "end"] == slices_df.loc[indx[1], "end"]:
    #             slices_df.loc[indx[0], "end"] = slices_df.loc[indx[1], "start"] - 1
    #     return slices_df
...
if __name__ == "__main__":
    ...
    '''
    updated_df = slice_inside_frames(path_slices_csv="/home/lihi/FruitSpec/code/lihi/fsCounter/vision/trees_slicer/slice_by_distance/matan_dist/data_motcha_New_Hall_row_4/slices.csv",
                                     path_translations_csv="/home/lihi/FruitSpec/code/lihi/fsCounter/vision/trees_slicer/slice_by_distance/matan_dist/data_motcha_New_Hall_row_4/jai_translations.csv",
                                     frame_width=1535,
                                     output_path="/home/lihi/FruitSpec/code/lihi/fsCounter/vision/trees_slicer/slice_by_distance/matan_dist/data_motcha_New_Hall_row_4/all_slices.csv")
