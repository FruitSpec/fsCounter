...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = "/home/fruitspec-lab-3/FruitSpec/Data/grapes/training_data/Dino_SA_and_GT_US_031223"
        self.train_ann = "coco_train.json"
        self.val_ann = "coco_val.json"

        self.output_dir = '/home/fruitspec-lab-3/FruitSpec/Sandbox/Counter/grapes/Dino_SA_and_GT_US_031223'
        self.num_classes = 1
